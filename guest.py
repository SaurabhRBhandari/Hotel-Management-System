...
from utils import *
from new_guest_prompt import *
from edit_guest_prompt import *
class Guest():
    ...
    def create_widgets(self):
        ...
        b2=tk.Button(self.frame1,text='Update',width=10,command=self.update)
        b3=tk.Button(self.frame1,text='Delete',width=10,command=self.delete)
