...
class NewRoomForm(tk.Frame):
    def __init__(self, parent):
        ...
        self.type_menu = tk.OptionMenu(self, self.type_var,"Select room type", *self.get_room_type_list())

        self.room_status_var = tk.BooleanVar(self,value=True)
        self.room_status_checkbox = tk.Checkbutton(self, text="Room Availability", variable=self.room_status_var)
