...
class Reserve():
    ...
    def create_widgets(self):
        welcome_label = tk.Label(self.frame, text="Welcome To Hotel Management System!", font=("Arial", 24), fg="blue")

        welcome_label.pack(padx=250,pady=50)
        b1=tk.Button(self.frame1,text='Make a Booking',width=10,command=self.add)
