    ...
    def create_widgets(self):
        ...
        for room in rooms:
            if room[1] :  # room is vacant
                ...
                fill_color = "red"
            canvas.create_rectangle(x, y, x+50, y+50, fill=fill_color)
        ...
        pie_button = tk.Button(self, text="Generate Pie Chart", command=self.generate_pie_chart)
        pie_button.pack(side=tk.BOTTOM)
